...
| <a href = "https://github.com/hasnainiftikhar/BI-HR-Analytics-Dashboard"> BI_HR_Analytics_Dashboard </a>  |   Data analysis   |   Designed Power BI dashboard to provide real-time insights on employee performance, turnover rate, and recruitment progress   |   Performance Management, Employee Demographics, Key HR Metrics, Training and Development   
| <a href = "https://github.com/hasnainiftikhar/SQL-BI-SalesReportingDashboard"> SQL_BI_SalesReporting_Dashboard </a>   |   Data analysis   |   A business intelligence (BI) solution aimed at providing comprehensive sales reporting and analysis capabilities to an organization using SQL | Sales Overview, Customization and Exporting, Sales Team Performance, Product Analysis, Geographic Analysis
| <a href = "https://github.com/hasnainiftikhar/SQL-Company-Sales-Data-Study"> SQL_Customer&Sales_Analysis </a>   |   Data analysis   |   Performed sales analysis on company's data using SQL, resulting in insights that informed marketing strategies and improved revenue performance   | Data Modeling, Customer Analytics, Sales Performance Analysis, KPIs Enhancement  
